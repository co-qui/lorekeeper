...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Guides' => 'admin/guides', ($page->id ? 'Edit' : 'Create').' Guide' => $page->id ? 'admin/guides/edit/'.$page->id : 'admin/guides/create']) !!}

<h1>{{ $page->id ? 'Edit' : 'Create' }} Guide
...
{!! Form::open(['url' => $page->id ? 'admin/guides/edit/'.$page->id : 'admin/guides/create', 'files' => true]) !!}
...
$( document ).ready(function() {    
    $('.delete-page-button').on('click', function(e) {
        e.preventDefault();
        loadModal("{{ url('admin/guides/delete') }}/{{ $page->id }}", 'Delete Guide');
    });
});
