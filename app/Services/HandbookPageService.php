...
class HandbookPageService extends Service
{
    ...
    */
     ...
     * @return bool|\App\Models\HandbookPage
     */
     ...
     * Updates a site page.
     *
     * @param  \App\Models\HandbookPage   $news
     * @param  array                  $data 
     * @param  \App\Models\User\User  $user
     * @return bool|\App\Models\HandbookPage
     */
    ...
    public function updateCategory($category, $data, $user)
    {
        ...
        try {
            ...
            if(HandbookCategory::where('name', $data['name'])->where('id', '!=', $category->id)->exists()) throw new \Exception("The name has already been taken.");
    ...
    public function deleteCategory($category)
    {
        ...
        try {         
            ...
            if(HandbookPage::where('category_id', $category->id)->exists()) throw new \Exception("A handbook uses this category. Please change its category first.");
