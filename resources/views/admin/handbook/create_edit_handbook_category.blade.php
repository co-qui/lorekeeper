...
@section('admin-content')
    {!! breadcrumbs([
        'Admin Panel' => 'admin',
        'Handbook Categories' => 'admin/handbooks/categories',
        ($category->id ? 'Edit' : 'Create') . ' Category' => $category->id ? 'admin/handbooks/categories/edit/' . $category->id : 'admin/handbooks/categories/create',
    ]) !!}
